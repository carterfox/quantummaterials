-------------------------------------------------------------------------------
--
-- File: FlxRioPkgNiUtilitiesDsp.vhd
...
--                                                                           --
-- Purpose:                                                                  --
-- FlxRioPkgNiUtilitiesDsp will provide some commonly needed functions that are not   --
...
--                                                                           --
-- Log2 is intended to help write re-usable components. Check out the        --
...
-- must be called "long hand" as in WORK.FlxRioPkgNiUtilitiesDsp.Min(1,2).            --
--                                                                           --
-------------------------------------------------------------------------------
library IEEE;
...
Package FlxRioPkgNiUtilitiesDsp is
  ...
  -- returns ceiling of base-2 logarithm
  ...
  -- must use the expanded name "WORK.FlxRioPkgNiUtilitiesDsp.Min(x,y)" to avoid
  ...
  function SetBits(Indices : NaturalVector; W : natural := 32) return std_logic_vector;
  function SetBit(Index : natural;
                  Val : std_logic := '1';
                  W : natural := 32) return std_logic_vector;
  function SetBit(Index : natural; W : natural := 32) return std_logic_vector;
  function SetBit(Index : natural;
                  Val : boolean;
                  W : natural := 32) return std_logic_vector;
...
end Package FlxRioPkgNiUtilitiesDsp;

Package body FlxRioPkgNiUtilitiesDsp is
  ...
  function SetBits(Indices : NaturalVector; W : natural := 32) return std_logic_vector is
  ...
  function SetBit(Index : natural;
                  Val : std_logic := '1';
                  W : natural := 32) return std_logic_vector is
    variable Data : std_logic_vector(W-1 downto 0);
  begin
    --synthesis translate_off
    assert Index < W report "Index must be less than W" severity error;
  ...
  function SetBit(Index : natural; W : natural := 32) return std_logic_vector is
  begin
...
end Package body FlxRioPkgNiUtilitiesDsp;
