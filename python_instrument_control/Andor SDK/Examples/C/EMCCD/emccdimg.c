//------------------------------------------------------------------------------
//  PROJECT:		32-bit Driver Example Code:Electron multiplication amplification
//
...
//							image acquisition and display it on the screen. It will
...
BOOL CreateWindows(void)
{
  ...
  ebExposure=CreateWindow("EDIT","",
                        WS_CHILD|WS_VISIBLE|WS_BORDER|ES_LEFT,
                        270,100,50,20,hwnd,0,hInstance,NULL);
  stGain=CreateWindow("STATIC","Gain level (0-255):",
                        WS_CHILD|WS_VISIBLE|SS_LEFT,
...
void SetSystem(void)
{
  ...
  if (errorValue != DRV_SUCCESS)
    wsprintf(aBuffer,"EMCCD Gain error\r\n");
