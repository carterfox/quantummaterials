...
lab_data_folder = '/Users/carterfox/Library/CloudStorage/GoogleDrive-cdfox@wisc.edu/.shortcut-targets-by-id/1-8q9lGFnGNt4mDzcxXwdk43m1aVWT66q/XiaoWang_Group_data_2024on/StackingTransitions/NbOI2/Lvgroup/UEM-samples/UEMsamples-raman/'
# BN_file = data_subfolder+'BN.txt'
# file5 = lab_data_folder + 'thickish.txt'
s1_p1 = lab_data_folder+'sample2-p1.txt'
...
file1_data = pd.read_table(s1_p1,comment='#',names=['Raman Shift','Counts'])
...
# y=119
z=1
plt.plot(file1_data['Raman Shift'],file1_data['Counts'],linewidth=z,c='r',label='s2-p1')
...
plt.savefig(lab_data_folder+'sample2-raman.png',bbox_inches='tight')
