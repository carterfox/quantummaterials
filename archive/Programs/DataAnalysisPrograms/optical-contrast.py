...
layers = np.array([0,1,2, 2, 2, 2,3,3,3, 4,4,4,5,5,3,3,1,4,5,6,3])
contrasts = np.array([0,4.3,8.3,8.7,8.7,9, 11.9, 12.2,11.6,14.6,15.,15.1,17.,17.2,11.2,11.3,4.2,14.8,17.37,19.6,11.3])
...
plt.savefig(path+'contrast_curve')
plt.show()
